      	...
      	<div class="col-md-12">
      		<div class="table-responsive">
	    		<table class="table table-bordered table_style1">
					...
					<td>
					<p>Best care Pharmaceuticals, Pondicherry</p>
					</td>
					<td>
					<p>Industrial Visit, Research and Internship Training</p>
					</td>
					</tr>
					<tr>
					<td>
					...
					<td>
					<p>Department of Science and Technology,<br /> Government of India, New Delhi</p>
					</td>
					<td>
					...
					<td>
					<p><em>Kaleesuwari </em>Refinery Pvt Ltd, Chennai</p>
					</td>
					<td>
					<p>Research</p>
					</td>

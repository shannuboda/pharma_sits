				    ...
				    <div class="container">
				          ...
				          <div class="pages_tabs1">
				              ...
				              <ul class="nav tab_style2" role="tablist">
				              	<li class="nav-item">
				                  <a class="nav-link active" data-toggle="tab" href="#tab0">Hospital Training <span class="dropdown-toggle"></span></a>
				              	</li>
				              	<li class="nav-item">
				                  <a class="nav-link" data-toggle="tab" href="#tab1">Indusrial Training<span class="dropdown-toggle"></span></a>
				              	</li>
				              </ul>
				          </div>
				          	...
				          	<div class="course_section">
					          	<div class="">
						              <div class="tab-content r_last_li" id="tab_parent">
						                <div id="tab0" class="tab-pane active">
						                	<h4>Hospital Training</h4>
						                	<div class="row">
										      	<div class="col-md-12">
										      		<span class="wrap_image_sec right">
						                				<img src="images/training/hospital.jpg" alt="KMCH" class="mb-3 mb-sm-3">
						                			</span>
										      		<p>The students of our institution are trained in 1000 bedded multispecialty KMCH hospital as per the requirements of curriculum prescribed by Pharmacy Council of India and the Tamil Nadu Dr. M.G.R Medical University, Chennai.</p>
													<p>The students get exposed to various practical aspects like sterile preparation, compounding, storage, requisition and prescription handling in both outpatient and inpatient pharmacy. Traditionally, the training is provided to contrast the time spent in pharmacy practice settings to time in didactic classrooms. This training reinforces the theory learnt in the hospital and community pharmacy courses and would make the students appreciate the challenges that are faced in the working life of a pharmacist. The hospital training is provided on rotational basis in Out-Patient (OP) Pharmacy, Central In-Patient (IP) Pharmacy, Sterile Supply Department (CSSD), pharmacy store management, patient counseling, Drug Information Centre (DIC) and also in the department of Microbiology, Biochemistry and Pathology. The students are trained in dispensing of medication/prescription that allows the students to improve their communication skills and counter service and also get familiarized with drug name,  generic name, brands available, dose, frequency, duration of a drug etc. Getting trained in the patient counseling department enhances the students’ knowledge on the use of devices like inhalers (MDI, spacers and rotahalers), insulin pens etc. </p>
										      	</div>
										      </div>
						                </div>
						                <div id="tab1" class="tab-pane">
						                	<h4>Indusrial Training</h4>
					                		<div class="row">
										      	<div class="col-md-12">
										      		<span class="wrap_image_sec right">
						                				<img src="images/training/industrial.jpg" alt="KMCH" class="mb-3 mb-sm-3">
						                			</span>
										      		<p>Major objective of industrial training is to improve their knowledge and skills relevant to their area of study, relate the knowledge and skills acquired at the workplace and in campus.</p> 
										      		<p>After industrial training, students can compete effectively in the job market as they have equipped with requisite knowledge, skills, attitudes and practical experience.</p>
													...
													<div class="table-responsive">
														<table class="table table-bordered table_style1">
															...
															<th>
															<p><strong>List of Pharma Industries where our students undergone Industrial training </strong></p>
															</th>
															</tr>
															<tr>
															<td>
															...
															<td>
															<p>Areete lifesciences Pvt ltd, Chennai</p>
															</td>
															</tr>
															<tr>
															<td>
															...
															<td>
															<p>Bafna Pharmaceuticals Ltd, Chennai</p>
															</td>
															</tr>
															<tr>
															<td>
															...
															<td>
															<p>Bestcare Formulation Pvt. Ltd, Pondicherry</p>
															</td>
															</tr>
															<tr>
															<td>
															...
															<td>
															<p>Lifecare Pharmaceuticals, Pondicherry</p>
															</td>
															</tr>
															<tr>
															<td>
															...
															<td>
															<p>Medinok Healthcare Pvt Ltd, Pondicherry</p>
															</td>
															</tr>
															<tr>
															<td>
															...
															<td>
															<p>Pharma Fabrikon Pvt Ltd, Madurai</p>
															</td>
															</tr>
															<tr>
															<td>
															...
															<td>
															<p>Ordain Healthcare Global Pvt Ltd, Chennai</p>
															</td>
															</tr>
															<tr>
															<td>
															...
															<td>
															<p>Reltsen Health Care , Pondicherry</p>
															</td>
															</tr>
															<tr>
															<td>
															...
															<td>
															<p>Vishupon Pharmaceuticals, Erode</p>
															</td>
															</tr>
															</tbody>
														</table>

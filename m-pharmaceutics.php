				...
				<section class="section_padding" id="tab_section">
				    <div class="container">
			              <div class="dept_title">
			              	<h2>M. Pharm in Pharmaceutics</h2>
					          	...
					          	<div class="">
						              <div class="tab-content" id="tab_parent">
						                <div id="tab0" class="tab-pane active">
						                	...
						                	<div class="row">
						                		<div class="col-md-7">
						                			<p>Pharmaceutics is the discipline of pharmacy that holds with procedure of converting a new chemical entity into a safe and effective formulation. Pharmaceutics is the science of dosage form deals with the formulation of a pure drug substance into a dosage form. Pharmaceutics involves the tracks like drug delivery technologies, novel drug delivery systems, routes of drug administration, pharmaceutical nanotechnology, Nano pharmaceutics and advanced drug delivery, bio therapeutics as novel technique in drug delivery, drug delivery device development and major challenges in drug delivery.</p>
						                		...
						                		<div class="col-md-5">
						                			<span class="wrap_image_sec mr-0">
							                			<img src="images/academics/programme/m-pharmaceutics.jpg" alt="m-pharmaceutics" class="w-100">
							                		</span>
						                		</div>
						                	</div>
						                ...
						                <div id="tab3" class="tab-pane">
						                	...
						                	<div class="table-responsive">
						                		<table class="table table_style1 table-striped table-bordered">
													...
													<td>
													<p>Advanced Biopharmaceutics and Pharmacokinetics</p>
													</td>
													</tr>
													<tr>
													<td>
													...
													<td>
													<p>Scale up and Technology Transfer</p>
													</td>
													</tr>
													<tr>
													<td>
													<p>Modern Pharmaceutics</p>
													</td>
													<td>
													<p>Pharmaceutical Production Technology</p>
													</td>
													</tr>
													<tr>
													<td>
													<p>Regulatory Affair</p>
													</td>
													<td>
													...
													<tr>
													<td>
													<p>Pharmaceutics Practical I</p>
													</td>
													<td>
													<p>Industrial Pharmacy Practical II</p>
													</td>
													</tr>
													<tr>
													<td>

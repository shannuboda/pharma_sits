				...
				<section class="section_padding" id="tab_section">
				    <div class="container">
			              <div class="dept_title">
			              	<h2>M. Pharm in Pharmaceutical Analysis</h2>
					          	...
					          	<div class="">
						              <div class="tab-content" id="tab_parent">
						                <div id="tab0" class="tab-pane active">
						                	...
						                	<div class="row">
						                		<div class="col-md-7">
						                			<p>Pharmaceutical analysis is an extensive program of study that includes qualitative and quantitative analysis of drugs, various pharmaceutical dosage forms and impurities etc to meet the regulatory requirements. The program deals mainly with technical and practical aspects of the drug development including bioanalytical research, analytical method development, volatile organic constituent analysis, cosmetic analysis, food analysis and structural characterization. </p>
						                		...
						                		<div class="col-md-5">
						                			<span class="wrap_image_sec mr-0">
							                			<img src="images/academics/programme/m-pharmaceutical-analysis.jpg" alt="m-pharmaceutical-analysis" class="w-100">
							                		</span>
						                		</div>
						                	</div>
						                ...
						                <div id="tab3" class="tab-pane">
						                	...
						                	<div class="table-responsive">
						                		<table class="table table_style1 table-striped table-bordered">
													...
													<tr>
													<td>
													<p>Modern Pharmaceutical</p>
													<p>Analytical Techniques</p>
													</td>
													<td>
													<p>Advanced Instrumental</p>
													<p>Analysis</p>
													</td>
													</tr>
													<tr>
													<td>
													<p>Advanced Pharmaceutical Analysis</p>
													</td>
													<td>
													<p>Modern Bio&ndash;Analytical Techniques</p>
													</td>
													</tr>
													<tr>
													<td>
													<p>Pharmaceutical Validation</p>
													</td>
													<td>
													...
													<td>
													<p>Herbal and Cosmetic Analysis</p>
													</td>
													</tr>
													<tr>
													<td>
													<p>Pharmaceutical&nbsp; Analysis Practical I</p>
													</td>
													<td>
													<p>Pharmaceutical&nbsp; Analysis Practical II</p>
													</td>
													</tr>
													<tr>
													<td>

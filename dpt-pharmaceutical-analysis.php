				...
				<section class="section_padding" id="tab_section">
				    <div class="container">
			              <div class="dept_title">
			              	<h2>Department of Pharmaceutical Analysis</h2>
						              ...
						              <div class="tab-content" id="tab_parent">
						                <div id="tab0" class="tab-pane active">
						                	...
						                	<div class="clear">
												...
												<p>Students will be learning about the qualitative and quantitative determination of APIs and pharmaceutical formulations using various analytical techniques like titrimetric, electrochemical spectroscopic and chromatographic methods.</p>												
						                	</div>
						                	
						                </div>
						                <div id="tab1" class="tab-pane r_last_li">
						                	<h4>Salient Features of Department</h4>
						                	<p>Department of pharmaceutical analysis provides technical skills and hands on experience for handling the following sophisticated instruments </p>
						                	<div class="row">
						                		<div class="col-md-7">
													  <ul class="ul_style">
													  	<li>UV-Visible Spectrophotometer - Shimadzu 1700</li>
														<li>UV-Visible Spectrophotometer - Shimadzu 1800</li>
														<li>HPTLC - Camag Linomat 5</li>
														<li>HPLC - Shimadzu LC 20 AD</li>
														<li>HPLC - Shimadzu LC 20 AT</li>
														<li>HPLC - Shimadzu LC 20 AP</li>
														<li>FTIR - JASCO 4600</li>
														<li>Spectrofluorometer - JASCO FP6200</li>
														<li>Gas Chromatograph - Perkin Elmer Clarus 590</li>
														<li>Flame Photometer - Elico PL22D</li>
													  </ul>
						                		</div>
						                		<div class="col-md-5">
						                	...
						                	<div class="row">
						                		...
						                		<div class="col-md-7">
						                			<h4>Activities</h4>
						                			<p>In addition to teaching of the theoretical and practical aspects of different analytical methods, the following activities are also been carried out in the department of pharmaceutical analysis.</p>
						                			<ul class="ul_style">
														<li>Quality control tests for APIs and finished pharmaceutical formulations</li>
														<li>Hands on training for sophisticated instruments</li>
														<li>Facilitate the students in Interpreting the data obtained from IR, NMR and Mass spectra of various organic compounds.</li>
						                			</ul>
						                		</div>
						                	</div>						                	
						                </div>

				...
				<section class="section_padding" id="tab_section">
				    <div class="container">
			              <div class="dept_title">
			              	<h2>M. Pharm in Pharmacology</h2>
			              	<a href="m-pharmacy.php">&lt; back</a>
			              </div>
					          	...
					          	<div class="">
						              <div class="tab-content" id="tab_parent">
						                <div id="tab0" class="tab-pane active">
						                	...
						                	<div class="row">
						                		<div class="col-md-7">
						                			<p>Pharmacology is the program that mainly deals with the science of drugs and their effect in the body. Pharmacology deception at the heart of pharmacy linking together chemistry, physiology and pathology. The department cooperates closely with other disciplines including pharmaceutical medicinal chemistry, phytochemistry, analytical chemistry, neuroscience, molecular and cell biology, immunology and cancer biology. The role of pharmacology is to discover new medicine to fight against physiological changes and disease, improving effectiveness of medication, reducing adverse effects of the medication.</p>
						                		...
						                		<div class="col-md-5">
						                			<span class="wrap_image_sec mr-0">
							                			<img src="images/academics/programme/m-pharmacology.jpg" alt="m-pharmacology" class="w-100">
							                		</span>
						                		</div>
						                	</div>
						                ...
						                <div id="tab1" class="tab-pane">
						                	...
						                	<ul class="ul_style">
						                		<li>Should have passed B.Pharmacy Degree with 55% marks from any recognized university or any other institute equivalent to university is eligible to pursue M.Pharm program.</li>
						                		<li>The candidate passed UG Degree course other than the Tamil Nadu Dr. M.G.R Medical University, Chennai has to obtain Eligibility Certificate from Tamil Nadu Dr. M.G.R Medical University, Chennai.</li>
						                	</ul>
						                </div>
						                ...
						                <div id="tab2" class="tab-pane">
						                	...
						                	<ul class="ul_style">
						                		<li>After M.Pharm students can be placed in various sectors of pharmaceutical industry and academic institutions </li>
												<li>Drug Discovery Research Centre</li>
												<li>Formulation R&D</li>
												<li>Regulatory affairs </li>
												<li>Technology Transfer</li>
												<li>Production chemist in manufacturing plant</li>
												<li>Teaching and academic research</li>
						                ...
						                <div id="tab3" class="tab-pane">
						                	...
						                	<div class="table-responsive">
						                		<table class="table table_style1 table-striped table-bordered">
													...
													<tr>
													<td>
													<p>Modern Pharmaceutical Analytical Techniques</p>
													</td>
													<td>
													<p>Advanced Pharmacology II</p>
													</td>
													</tr>
													<tr>
													<td>
													<p>Advanced Pharmacology&ndash;I</p>
													</td>
													<td>
													<p>Pharmacological and Toxicological Screening Methods&ndash;II</p>
													</td>
													</tr>
													<tr>
													<td>
													<p>Pharmacological &amp;&nbsp; Toxicological Screening Methods&ndash;I</p>
													</td>
													<td>
													<p>Principles of Drug Discovery</p>
													</td>
													</tr>
													<tr>
													<td>
													<p>Cellular and Molecular Pharmacology</p>
													</td>
													<td>
													<p>Experimental Pharmacology practical&ndash; II</p>
													</td>
													</tr>
													<tr>
													<td>
													<p>Pharmacology Practical I</p>
													</td>
													<td>
													<p>Pharmacology Practical II</p>
													</td>
													</tr>
													<tr>
													<td>
													<p>Seminar/Assignment</p>
													</td>
													<td>
													<p>Seminar/Assignment</p>
													</td>
													...
													<tr>
													<td>
													<p>Research Methodology and Biostatistics*</p>
													</td>
													<td>
													<p>Journal Club</p>
													</td>
													...
													<tr>
													<td>
													<p>Discussion / Presentation (Proposal Presentation)</p>
													</td>
													<td>
													<p>Discussion/Final Presentation</p>
													</td>
													</tr>
													<tr>
													<td>

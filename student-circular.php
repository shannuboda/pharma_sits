...
<section>
	<div class="page_banner">
		<img src="images/page_banner/alumni.jpg" alt="About NGP Physiotherapy" class="dt_img">
		<img src="images/page_banner/mobile/alumni.jpg" alt="About NGP Physiotherapy" class="mob_img">
				    ...
				    <div class="container">
				          ...
				          <div class="pages_tabs1">
				              ...
				              <ul class="nav tab_style2" role="tablist">
				              	<li class="nav-item">
				                  <a class="nav-link active" data-toggle="tab" href="#tab0">Internal Assessment 2023 <span class="dropdown-toggle"></span></a>
				              	</li>
						              ...
						              <div class="tab-content r_last_li" id="tab_parent">
						                <div id="tab0" class="tab-pane active">
						                	...
						                	<div class="row">
										      	<div class="col-md-12">
													<ul class="ul_style">
														<li><a href="pdf/examcell/Pharm.D (PB)  - I IA - Student's circular.pdf" target="_blank">Pharm.D (PB)  - I IA </a></li>														<li><a href="pdf/examcell/Pharm.D  - II IA - Student's circular.pdf" target="_blank">Pharm.D  - II IA </a></li>
													</ul>
										      	</div>
										      </div>
						                </div>
